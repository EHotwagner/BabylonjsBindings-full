...
const promotionFamilies = [
  ...
  },
  {
    ...
    description: "dependency-closed runtime class"
  },
  {
    maintainedPath: "src/BabylonjsBindings/SimpleFunctions.fs",
  ...
  {
    maintainedPath: "src/BabylonjsBindings/M2FiniteDependentMaps.fs",
