...
const packageVersion = process.env.M3_PACKAGE_VERSION ?? projectText.match(/<Version>([^<]+)<\/Version>/)?.[1];
...
let imageDefines (baseCtor: MaterialDefinesStatic) : ImageProcessingDefinesMaterialDefinesStatic = ImageProcessingDefinesMixin.Invoke(baseCtor)
