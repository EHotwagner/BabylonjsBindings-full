...
const ImageDefines = ImageProcessingDefinesMixin(MaterialDefines);
const imageDefines = new ImageDefines();
imageDefines.IMAGEPROCESSING = true;
imageDefines.markAsProcessed();
if (imageDefines.IMAGEPROCESSING !== true || imageDefines._isDirty !== false) throw new Error("image defines both-member mixin result failed");
...
console.log("M3 Node smoke passed: arity 0-10 boundary, 3 decorators, 3 mixins");
